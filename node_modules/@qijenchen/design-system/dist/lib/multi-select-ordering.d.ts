 ...
 * ```
 */
export declare function applySelectAll<T>(existing: readonly T[], all: readonly T[]): T[];
/**
 ...
 */
export declare function clearSelection<T>(): T[];
//# sourceMappingURL=multi-select-ordering.d.ts.map